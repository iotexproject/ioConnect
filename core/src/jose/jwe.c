...
static char * _fill_recipients_apv(char *recipients_kid[4])
{
    psa_status_t status;
...
char *iotex_jwe_encrypt_protected(enum KWAlgorithms KwAlg, enum EncAlgorithm enAlg, char *sender, char *recipients_kid[4], JWK *epk)
{
    ...
    protected.typ = DIDCOMM_JWE_ENCRPTY_TYP;
    protected.alg = KwAlg;
    protected.enc = enAlg;
...
////////////////////////////////////////////////////////////////////////////////
// static bool _cjose_jwe_set_cek_a256gcm(jwe_t *jwe, const JWK *jwk, bool random);

// static bool _cjose_jwe_set_cek_aes_cbc(jwe_t *jwe, const JWK *jwk, bool random);

// static bool
// _cjose_jwe_encrypt_ek_dir(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_decrypt_ek_dir(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_encrypt_ek_aes_kw(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_decrypt_ek_aes_kw(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_encrypt_ek_rsa_oaep(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_decrypt_ek_rsa_oaep(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_encrypt_ek_rsa1_5(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_decrypt_ek_rsa1_5(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_encrypt_ek_ecdh_es(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool
// _cjose_jwe_decrypt_ek_ecdh_es(_jwe_int_recipient_t *recipient, jwe_t *jwe, const JWK *jwk);

// static bool _cjose_jwe_set_iv_a256gcm(jwe_t *jwe);

// static bool _cjose_jwe_set_iv_aes_cbc(jwe_t *jwe);

// static bool _cjose_jwe_encrypt_dat_a256gcm(jwe_t *jwe, const uint8_t *plaintext, size_t plaintext_len);

// static bool _cjose_jwe_encrypt_dat_aes_cbc(jwe_t *jwe, const uint8_t *plaintext, size_t plaintext_len);

// static bool _cjose_jwe_decrypt_dat_a256gcm(jwe_t *jwe);

// static bool _cjose_jwe_decrypt_dat_aes_cbc(jwe_t *jwe);
...
////////////////////////////////////////////////////////////////////////////////
// static bool _cjose_empty_json(cJSON *arg)
// {

//     return (NULL == arg || cJSON_IsNull(arg) || cJSON_IsInvalid(arg));
// }

////////////////////////////////////////////////////////////////////////////////
// static void _cjose_dealloc_part(struct _jwe_part_int *part)
// {
//     if (part->raw)
//         free(part->raw);
